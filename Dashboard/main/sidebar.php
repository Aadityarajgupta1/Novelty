...
<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0" href="../../matri.php " target="_blank">
    <img src="./assets/Image/logo.png" class="navbar-brand-img h-100" alt="main_logo">
    <span class="ms-1 font-weight-bold text-white">Novelty</span>
  </a>
</div>
